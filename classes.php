...
class Parser
{
	...
	{
		file_put_contents("time", date("d.m.y"));
	}
	public function isLastParsToday()
	{
		return $this->getToday() == $this->getLastParser();
	}
	...
	public function parsUrl ($url, $proxy = false, $proxy_auth = false) {
	    if ( $curl = curl_init() ) {
